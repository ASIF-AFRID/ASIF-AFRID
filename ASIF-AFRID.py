...
\033[1;91m☞ Auther     : B4_ASIF_M4_AFRID
\033[1;92m☞ WhatsApp   : 03159599971
\033[1;95m☞ YouTube    : git clone https://youtube.com/channel/UCGM5o_mRJ4f4oqK7tbvcKLw
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/B4_AFRID')
	    os.system('cd $HOME && git clone https://github.com/ASIF-AFRID125/Baloch')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03159599971✓')
	    psb('WellCome To B4_AFRID')
	    psb('Congratulations B4_AFRID Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ ASIF✓')
	    psb('🔓Password ☆ AFRIDI✓')
	    psb('Subscrib My Youtube Channel B4 AFRID M4 AFRID ✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/B4_AFRID && python2 B4.py')
	elif bm =='3':
